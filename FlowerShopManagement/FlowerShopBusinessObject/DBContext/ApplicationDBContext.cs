    ...
    public partial class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category { Id = Guid.Parse("2C81C8F6-CAE1-46A6-9BC4-71F29F6DA74E"), CategoryName = "Hoa Hồng Đỏ", Description = "Đỏ" },
                new Category { Id = Guid.Parse("B7101212-C852-4BE6-8EED-031B096B2DD4"), CategoryName = "Hoa Hồng Đen", Description = "Đen" },
                new Category { Id = Guid.Parse("CB85B07B-2FCC-497C-9007-8912A86C2F4F"), CategoryName = "Hoa Lưu Ly", Description = "Lưu ly" },
                new Category { Id = Guid.Parse("D302148F-1677-4094-8FA7-1C6B54FF8B69"), CategoryName = "Hoa Lan", Description = "Lan" }
                );
